...
ParticleFireEmitter::ParticleFireEmitter():m_particles(nullptr), m_firstDead(0), m_maxParticles(0),
...
ParticleFireEmitter::~ParticleFireEmitter()
{
	delete[] m_particles;
	delete[] m_vertexData;
...
void ParticleFireEmitter::initalise(unsigned int a_maxParticles, unsigned int a_emitRate, float a_lifetimeMin, float a_lifetimeMax,
...
void ParticleFireEmitter::update(float a_deltaTime, const glm::mat4 & a_cameraTransform)
{
	using glm::vec3;
	using glm::vec4;
...
void ParticleFireEmitter::draw(mat4 ProjectionView)
{
